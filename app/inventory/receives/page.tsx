...
import {
  ...
  CheckCircle2, XCircle, Package, Filter,
} from 'lucide-react';
          ...
          <div className="data-table-wrap">
            <div className="overflow-x-auto">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-slate-700">
                  {paginated.map(r => (
                    <tr key={r.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/30">
                      <td className="px-4 py-3 font-mono text-sm font-medium text-gray-900 dark:text-white">{r.receive_number}</td>
              ...
              <div className="md:hidden divide-y divide-gray-100 dark:divide-slate-700">
                {paginated.map(r => (
                  <div key={r.id} className="p-4 hover:bg-gray-50 dark:hover:bg-slate-700/30 cursor-pointer" onClick={() => router.push(`/inventory/receives/${r.id}`)}>
